...
const BodyCard = () => {
        ...
        const [itmePage, setItemPage] = useState<number>(3)

        let lastView =itmePage * currentPage
        let firstView = lastView - itmePage

        let myData = veiwData.slice(firstView,lastView)
        let pages: number[]=[
        ]

            // for (let i=1;<Math.ceil(veiwData.length / itemPerPage);i++){
// pages.push
            // }
            useEffect(()=>{
